...
class FakeEvent extends Fake implements OTATVEvent {}

class FakeState extends Fake implements OTATVState {}

class MockBlocProvider extends MockBloc<OTATVEvent, OTATVState>
    implements OTATVBloc {}
...
void main() {
  ...
  setUp(() {
    ...
    widgetToTest = OTATVPage();
  });

  Widget _makeTestableWidget(Widget body) {
    return BlocProvider<OTATVBloc>(
      create: (c) => mockBloc,
      child: MaterialApp(
        home: body,
      ),
  ...
  Widget _makeAnotherTestableWidget(Widget body) {
    return BlocProvider<OTATVBloc>(create: (c) => mockBloc, child: body);
  }
