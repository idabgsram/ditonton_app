...
abstract class TVRepository {
  ...
  Future<Either<Failure, TVSeasons>> getTVSeasonsDetail(int tvId, int seasonNumber);
  Future<Either<Failure, TVEpisodes>> getTVEpisodesDetail(int tvId, int seasonNumber, int epsNumber);
